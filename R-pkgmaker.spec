...
Version  : 0.31
Release  : 26
URL      : https://cran.r-project.org/src/contrib/pkgmaker_0.31.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pkgmaker_0.31.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579711812
