...
Version  : 0.31.1
Release  : 29
URL      : https://cran.r-project.org/src/contrib/pkgmaker_0.31.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pkgmaker_0.31.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589781840
